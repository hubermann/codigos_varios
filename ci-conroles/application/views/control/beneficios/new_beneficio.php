...
$attributes = array('class' => 'form-horizontal', 'id' => 'new_beneficio');
echo form_open_multipart(base_url('control/beneficios/create/'), $attributes);

echo form_hidden('beneficio[id]');
