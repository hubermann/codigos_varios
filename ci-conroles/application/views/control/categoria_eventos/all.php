		...
		<div class="white-box">
			<h3 class="box-title"><?php echo $title; ?>
				<div class="col-md-2 col-sm-4 col-xs-12 pull-right text-right">
					...
					<a class="btn btn-primary btn-block btn-rounded waves-effect waves-light" href="<?php echo base_url('control/categoria_eventos/form_new'); ?>">Agregar +</a>
				</div>
			</h3>
						...
						if(count($query)){ 
							...
							foreach ($query as $row):
								...
								$body .= '<td> 
														...
														<a href="'.base_url('control/categoria_eventos/destroy/'.$row->id.'').'" class="delete btn btn-small" data-confirm="Are you sure to delete this item?"><i class="fa fa-trash-o"></i></a>
