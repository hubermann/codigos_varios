...
<?php
		...
		<i class="hs-icon hs-icon-arrow-bottom g-font-size-11 g-ml-7"></i></a>
				...
				<div class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
					<a class="btn u-btn-outline-primary g-font-size-13 text-uppercase g-py-10 g-px-15" href="<?= base_url('perfil-editar');?>" target="_blank"><?= "Hola ".$this->session->userdata('user_nickname');  ?></a>
				</div>
				<?php }else{ ?>
				<div class="d-inline-block g-hidden-xs-down g-pos-rel g-valign-middle g-pl-30 g-pl-0--lg">
