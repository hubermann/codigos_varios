				...
				<div class="card border-0 rounded-0 g-mb-50">
					...
					<div class="js-scrollbar card-block u-info-v1-1 g-bg-white-gradient-v1--after g-height-300 g-pa-0">
						...
						<div class="g-mb-20">
							...
							<small class="g-font-size-12">35% more than last week edn</small>
						</div>
			...
			<div class="col-lg-9">
				...
				<div id="nav-1-1-default-hor-left-underline" class="tab-content">
					...
					<div class="tab-pane fade show active" id="nav-1-1-default-hor-left-underline--1" role="tabpanel">
						...
						<!-- Current Nombre -->
							<div class="form-group row g-mb-25">
								...
								<div class="col-sm-9">
									<div class="input-group g-brd-primary--focus">
										<input class="form-control form-control-md border-right-0 rounded-0 g-py-13 pr-0" type="text" value="<?php echo $user->nickname; ?>" placeholder="Nickname">
							...
							<div class="form-group row g-mb-25">
								...
								<div class="col-sm-9">
									<div class="input-group g-brd-primary--focus">
										<input class="form-control form-control-md border-right-0 rounded-0 g-py-13 pr-0" type="text" value="<?php echo $user->nombre; ?>" placeholder="Nombre">
							...
							<div class="form-group row g-mb-25">
								...
								<div class="col-sm-9">
									<div class="input-group g-brd-primary--focus">
										<input class="form-control form-control-md border-right-0 rounded-0 g-py-13 pr-0" type="text" value="<?php echo $user->apellido; ?>" placeholder="Apellido">
					...
					<div class="tab-pane fade" id="nav-1-1-default-hor-left-underline--2" role="tabpanel">
						<h2 class="h4 g-font-weight-300">Security Settings nope</h2>
						<p class="g-mb-25">Reset your password, change verifications and so on.</p>
